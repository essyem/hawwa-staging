// Global HAWWA JS helpers for services
window.HAWWA = window.HAWWA || {};

(function () {
    function defaultFetch(url, options) {
        return fetch(url, options).then(function (resp) {
            // If response is JSON, return parsed JSON, else return text
    ...
    window.HAWWA.addToWishlist = function (serviceId) {
        var wishlistUrl = (window.HAWWA && window.HAWWA.wishlistUrl) || window.wishlist_url || null;
        if (!wishlistUrl) {
            console.error('Wishlist URL not configured');
            alert('Could not add to wishlist.');
            return;
        }

        var csrftoken = (function () {
            // Try window.CSRF_TOKEN or csrf cookie
        ...
        defaultFetch(wishlistUrl, {
            ...
            if (data.success) {
                ...
                // redirect to login
                var loginUrl = (window.HAWWA && window.HAWWA.loginUrl) || '/accounts/login/';
